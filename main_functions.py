...
def save_and_plot(optimal_stats, real_stats, rewards_stats, agents_tested,
    ...
    plt.title("Policy errors with the optimal policy on the model each agent learned")
    plt.savefig('Plots/pol_error_opti'+time_end +
    ...
    plt.savefig('Plots/pol_error_real'+time_end +
                names_environments[0]+'.pdf', bbox_inches='tight')
    plt.close()
    ...
    plt.savefig('Plots/Rewards'+time_end+names_environments[0]+'.pdf', bbox_inches='tight')
    plt.close()
